...
@Component({
  selector: 'app-verestadoconvocatorias',
  templateUrl: './verestadoconvocatorias.component.html',
  styleUrls: ['./verestadoconvocatorias.component.css']
})
export class VerestadoconvocatoriasComponent implements OnInit {
