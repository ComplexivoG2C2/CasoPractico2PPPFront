...
//ANEXO8
  ...
  ontnerDatos():Anexo9{
    ...
    this.anexo9.nombreDirectorProyecto=this.solicitudproyecto.nombretutoremp;
    this.anexo9.nombreDocenteApoyo=(this.solicitudproyecto.docenteApoyoResponse!=undefined)?this.solicitudproyecto.docenteApoyoResponse[0].nombres:"";
    this.anexo9.nombreEntidadBeneficiaria=this.solicitudproyecto.nombre;
  ...
  ggenerarDocumento9() {
    ...
    loadFile("https://raw.githubusercontent.com/Sbryan20/Sistema-PPProfesionales/main/src/assets/doc/anexo8.docx", function(
      ...
      doc.setData({
        ...
        entidad_beneficiaria:anexo9.nombreEntidadBeneficiaria,
        nombre_estudiante:anexo9.nombreEstudiante,
        identificiacion_est:anexo9.cedulaEstudiante,
        nombre_admin_entidad:anexo9.nombreAdminEB,
        docente_apoyo:anexo9.nombreDocenteApoyo,
        nombre_director:anexo9.nombreDirectorProyecto,
