...
import {RegistrocconvenioempService} from "../../../services/registrocconvenioemp.service";
...
@Component({
  selector: 'app-registroconvenioempresaver',
  templateUrl: './registroconvenioempresaver.component.html',
  styleUrls: ['./registroconvenioempresaver.component.css']
})
export class RegistroconvenioempresaverComponent implements OnInit {
  ...
  constructor(private router: Router,
              ...
              private registroservice:RegistrocconvenioempService) {
  ...
  ngOnInit(): void {
    this.activatedRoute.params.subscribe( params => {
      ...
      this.registroservice.getRegistroConvenio().subscribe(value => {
        this.registroconvenio =value.filter(v=>v.nombreEmpresa==nombres);
        this.isexist=value.length!=0;
        console.log("nombre empresa"+nombres)
